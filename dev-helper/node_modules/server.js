...
var installer = require('../routes/installer.js');
...
// Installers
server.get('/api/installer', installer.findAll);
server.post('/api/installer/generate', installer.generate);
// Commands
server.get('/api/command', command.findAll);
server.get('/api/command/:id', command.findById);
server.post('/api/command', command.insert);
server.put('/api/command/:id', command.update);
server.delete('/api/command/:id', command.remove);
server.post('/api/command/reload', command.reload);
// Scripts
server.get('/api/script', script.findAll);
server.get('/api/script/:id', script.findById);
server.post('/api/script', script.insert);
server.put('/api/script/:id', script.update);
server.delete('/api/script/:id', script.remove);

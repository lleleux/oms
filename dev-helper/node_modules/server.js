...
// Server Config
server.get('/api/server/:id/config/:key', servers.getConfig);
...
server.put('/api/server/:id/config/:key', servers.addConfig);
// Service Config
...
// API Documentation
server.get('/api/doc/api', docApi.findAll);
server.post('/api/doc/api/reload', docApi.reload);
